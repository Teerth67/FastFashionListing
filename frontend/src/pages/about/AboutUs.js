...
const AboutUs = () => {
  ...
  return (
    ...
    >
      ...
      <p className={styles.description}>
        The Movement Founded in 2025, <span className={styles.brand}>GLITCH'D</span> was born from a desire to disrupt fast fashion. We're here to blur the lines between trends and individuality—because style isn't about fitting in; it's about standing out. No limits. No labels. Just raw, unfiltered expression.
      </p>
      <p className={styles.description}>
        Our Vibe We curate the freshest, most daring streetwear from across the globe, so you don't have to spend hours scrolling. From underground aesthetics to viral drops, our collections are designed to keep you ahead of the curve. Bold statements. Unfiltered attitude. A global community. A future-forward mindset.<span className={styles.highlight}> Inclusive vibes,Exclusive styles.</span> That's the movement. That's the future.
      </p>
      <p className={styles.description}>
